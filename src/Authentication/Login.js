...
const Login = () => {
  ...
  const submitHandler = (event) => {
    ...
    if (isLogin) {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyD1gq-4-XPSi46gVc6QZejldrzhJYhzsI4";
    } else {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyD1gq-4-XPSi46gVc6QZejldrzhJYhzsI4";
    }
